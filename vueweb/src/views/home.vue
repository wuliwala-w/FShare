                ...
                <el-col >
                    ...
                    >
                        <router-link to="/home/mine">
                            <el-menu-item index="1" style="display: flex;justify-content: center;font-size: 24px;align-items: center;height: 70px;">
                            <div style="display: flex;width: 100%;justify-content: flex-start;align-items: center;margin-left: 30%;">
                                    <div style="display: flex;justify-content: flex-start">
                                        我的
                                        <el-icon v-show="active==1" style="display: flex;align-items: center;margin-left: 5px"><Star class="my-icon" /></el-icon>
                                    </div>
                            </div>
                        </el-menu-item>
                        </router-link>
                        <router-link to="/home/upload"><el-menu-item index="2" style="display: flex;justify-content: center;font-size: 24px;align-items: center;height: 70px;">
                            <div style="display: flex;width: 100%;justify-content: flex-start;align-items: center;margin-left: 30%;">
                                上传
                        ...
                        <el-menu-item index="3" style="display: flex;justify-content: center;font-size: 24px;align-items: center;eight: 70px;">
                            <div style="display: flex;width: 100%;justify-content: flex-start;align-items: center;margin-left: 30%;">
                                浏览
